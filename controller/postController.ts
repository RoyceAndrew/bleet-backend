...
const getReply = async (req: Request, res: Response): Promise<void> => {
  try {
    const { username } = req.params;
...
const followList = async (req: Request, res: Response): Promise<void> => {
  try {
...
const getFollow = async (req: Request, res: Response): Promise<void> => {
  try {
    const { id } = req.params;
...
const getFollowPosts = async (req: Request, res: Response): Promise<void> => {
  try {
    const { id } = req.body;
